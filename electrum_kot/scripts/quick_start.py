...
from electrum_kot.wallet import Wallet, create_new_wallet
from electrum_kot.wallet_db import WalletDB
from electrum_kot.commands import Commands
from electrum_kot.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-kot/testnet as datadir
