...
from electrum_kot import WalletStorage, Wallet
from electrum_kot.wallet import Abstract_Wallet
from electrum_kot.wallet_db import WalletDB
from electrum_kot.util import format_satoshis, EventListener, event_listener
from electrum_kot.bitcoin import is_address, COIN
from electrum_kot.transaction import PartialTxOutput
from electrum_kot.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def network_dialog(self):
        print("use 'electrum-kot setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-kot setconfig' to change your settings")
        return True
