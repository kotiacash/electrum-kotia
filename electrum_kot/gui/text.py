...
from electrum_kot.gui import BaseElectrumGui
from electrum_kot.bip21 import parse_bip21_URI
from electrum_kot.util import format_satoshis, format_time
from electrum_kot.util import EventListener, event_listener
from electrum_kot.bitcoin import is_address, address_to_script, COIN
from electrum_kot.transaction import PartialTxOutput
from electrum_kot.wallet import Wallet, Abstract_Wallet
from electrum_kot.wallet_db import WalletDB
from electrum_kot.storage import WalletStorage
from electrum_kot.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_kot.interface import ServerAddr
from electrum_kot.invoices import Invoice
from electrum_kot.invoices import PR_DEFAULT_EXPIRATION_WHEN_CREATING
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def __init__(self, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'electrum-kot create'")
            exit()
