...
from electrum_kot.bitcoin import DummyAddress
from electrum_kot.plugin import run_hook
from electrum_kot.util import NotEnoughFunds, NoDynamicFeeEstimates, parse_max_spend
from electrum_kot.invoices import PR_PAID, Invoice, PR_BROADCASTING, PR_BROADCAST
from electrum_kot.transaction import Transaction, PartialTxInput, PartialTxOutput
from electrum_kot.network import TxBroadcastError, BestEffortRequestFailed
from electrum_kot.payment_identifier import PaymentIdentifierState, PaymentIdentifierType, PaymentIdentifier, \
...
class SendTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        msg = (_("Recipient of the funds.")
               ...
               + _("- a Blackcoin address or BIP21 URI") + "\n"
