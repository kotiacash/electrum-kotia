...
from electrum_kot.bip32 import is_bip32_derivation, BIP32Node, normalize_bip32_derivation, xpub_type
from electrum_kot.daemon import Daemon
from electrum_kot.i18n import _
from electrum_kot.keystore import bip44_derivation, bip39_to_seed, purpose48_derivation, ScriptTypeNotSupported
from electrum_kot.plugin import run_hook, HardwarePluginLibraryUnavailable
from electrum_kot.storage import StorageReadWriteError
from electrum_kot.util import WalletFileException, get_new_wallet_name, UserFacingException, InvalidPassword
from electrum_kot.wallet import wallet_types
from .wizard import QEAbstractWizard, WizardComponent
from electrum_kot.logging import get_logger, Logger
from electrum_kot import WalletStorage, mnemonic, keystore
from electrum_kot.wallet_db import WalletDB
from electrum_kot.wizard import NewWalletWizard

from electrum_kot.gui.qt.bip39_recovery_dialog import Bip39RecoveryDialog
from electrum_kot.gui.qt.password_dialog import PasswordLayout, PW_NEW, MSG_ENTER_PASSWORD, PasswordLayoutForHW
from electrum_kot.gui.qt.seed_dialog import SeedLayout, MSG_PASSPHRASE_WARN_ISSUE4566, KeysLayout
from electrum_kot.gui.qt.util import (PasswordLineEdit, char_width_in_lineedit, WWLabel, InfoButton, font_height,
...
if TYPE_CHECKING:
    ...
    from electrum_kot.plugin import Plugins
    from electrum_kot.daemon import Daemon
    from electrum_kot.gui.qt import QElectrumApplication
...
class WCWalletType(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ('imported',  _('Import Kotia addresses or private keys')),
        ]
    ...
    def on_ready(self):
        ...
        if self.wizard_data['wallet_type'] == 'multisig':
            choices = [
                ...
                # Kotia: disable SegWit wallets for now
...
class WCImport(WizardComponent):
    def __init__(self, parent, wizard):
        WizardComponent.__init__(self, parent, wizard, title=_('Import Kotia Addresses or Private Keys'))
        message = _(
            'Enter a list of Kotia addresses (this will create a watching-only wallet), or a list of private keys.')
