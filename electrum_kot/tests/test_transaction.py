...
from electrum_kot import transaction, bitcoin
from electrum_kot.transaction import (convert_raw_tx_to_hex, tx_from_any, Transaction,
...
from electrum_kot.bitcoin import (deserialize_privkey, opcodes,
