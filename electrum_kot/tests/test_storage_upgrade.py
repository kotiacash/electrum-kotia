...
from electrum_kot.wallet_db import WalletDBUpgrader, WalletDB, WalletRequiresUpgrade, WalletRequiresSplit
from electrum_kot.wallet import Wallet
...
##########
    ...
    plugins: 'electrum_kot.plugin.Plugins'
