...
from electrum_kot import storage, bitcoin, keystore, bip32, slip39, wallet
from electrum_kot import Transaction
from electrum_kot import SimpleConfig
from electrum_kot import util
from electrum_kot.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from electrum_kot.wallet import (sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet,
                             restore_wallet_from_text, Abstract_Wallet, CannotBumpFee)
from electrum_kot.util import (
    bfh, NotEnoughFunds, UnrelatedTransactionException,
    UserFacingException)
from electrum_kot.transaction import (TxOutput, Transaction, PartialTransaction, PartialTxOutput,
                                  PartialTxInput, tx_from_any, TxOutpoint)
from electrum_kot.mnemonic import seed_type
from electrum_kot.network import Network

from electrum_kot.plugins.trustedcoin import trustedcoin
...
class TestWalletSending(ElectrumTestCase):
    ...
    async def test_coinjoin_between_two_p2wpkh_electrum_seeds(self, mock_save_db):
        ...
        tx1 = wallet1.create_transaction(outputs=outputs, fee=5000, tx_version=2, rbf=False, sign=False)
        ...
        tx2 = wallet2.create_transaction(outputs=outputs, fee=5000, tx_version=2, rbf=False, sign=False)
...
class TestWalletOfflineSigning(ElectrumTestCase):
    ...
    async def test_sending_offline_wif_online_addr_p2wpkh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value('tb1quk7ahlhr3qmjndy0uvu9y9hxfesrtahtta9ghm', 2500000)]
<<<<<<< HEAD:electrum_kot/tests/test_wallet_vertical.py
