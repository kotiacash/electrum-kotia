...
from electrum_kot import bip32, constants
from electrum_kot.i18n import _
from electrum_kot.keystore import Hardware_KeyStore
from electrum_kot.transaction import PartialTransaction, Sighash
from electrum_kot.wallet import Multisig_Wallet, Deterministic_Wallet
from electrum_kot.util import UserFacingException
from electrum_kot.logging import get_logger
from electrum_kot.plugin import Device, DeviceInfo, runs_in_hwd_thread
from electrum_kot.simple_config import SimpleConfig
from electrum_kot.storage import get_derivation_used_for_hw_device_encryption
from electrum_kot.bitcoin import OnchainOutputType

import electrum_kotk.bitcoin as bitcoin
import electrum_kot.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def coin_network_from_electrum_network(self) -> int:
        if constants.net.TESTNET:
            return bitbox02.btc.TKOT
        return bitbox02.btc.KOT
    ...
    def get_xpub(self, bip32_path: str, xtype: str, *, display: bool = False) -> str:
        ...
        if xtype == "p2wpkh":
            ...
            if coin_network == bitbox02.btc.KOT:
    ...
    def _get_coin(self):
        return bitbox02.btc.TKOT if constants.net.TESTNET else bitbox02.btc.KOT
