...
from electrum_kot.gui.qt.util import WaitingDialog, EnterButton, WindowModalDialog, read_QIcon
from electrum_kot.i18n import _
from electrum_kot.logging import get_logger

if TYPE_CHECKING:
    from electrum_kot.gui.qt.transaction_dialog import TxDialog
