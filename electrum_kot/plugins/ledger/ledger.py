...
from electrum_kot import bip32, constants, ecc
from electrum_kot import descriptor
from electrum_kot.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, normalize_bip32_derivation
from electrum_kot.bitcoin import EncodeBase58Check, int_to_hex, is_b58_address, is_segwit_script_type, var_int
from electrum_kot.crypto import hash_160
...
from electrum_kot.plugin import Device, runs_in_hwd_thread
from electrum_kot.transaction import PartialTransaction, Transaction, PartialTxInput
from electrum_kot.util import bfh, UserFacingException, versiontuple
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Kotia" app) too old for Segwit support. Please update at') + \
    ' https://www.ledger.com'
