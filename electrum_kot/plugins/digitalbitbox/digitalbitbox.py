...
from electrum_kot.crypto import sha256d, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_kot.bitcoin import public_key_to_p2pkh
from electrum_kot.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_kot.bip32 import normalize_bip32_derivation
from electrum_kot import descriptor
from electrum_kot import ecc
from electrum_kot.ecc import msg_magic
from electrum_kot.wallet import Standard_Wallet
from electrum_kot import constants
from electrum_kot.transaction import Transaction, PartialTransaction, PartialTxInput, Sighash
from electrum_kot.i18n import _
from electrum_kot.keystore import Hardware_KeyStore
from electrum_kot.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_kot.network import Network
from electrum_kot.logging import get_logger
from electrum_kot.plugin import runs_in_hwd_thread, run_in_hwd_thread

from ..hw_wallet import HW_PluginBase, HardwareClientBase, HardwareHandlerBase
from ..hw_wallet.plugin import OperationCancelled

if TYPE_CHECKING:
    from electrum_kot.plugin import DeviceInfo
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-KOT-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
