...
from electrum_kot.util import UserCancelled
from electrum_kot.keystore import bip39_normalize_passphrase
from electrum_kot.bip32 import BIP32Node, convert_bip32_strpath_to_intpath
from electrum_kot.logging import Logger
from electrum_kot.plugin import runs_in_hwd_thread
from electrum_kot.plugins.hw_wallet.plugin import HardwareClientBase, HardwareHandlerBase
    ...
    def callback_PassphraseRequest(self, req):
        ...
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the blackcoins in the wallet.").format(self.device)
        else:
