...
from electrum_kot.util import bfh, UserCancelled, UserFacingException
from electrum_kot.bip32 import BIP32Node
...
from electrum_kot.plugins.hw_wallet import HW_PluginBase
from electrum_kot.plugins.hw_wallet.plugin import is_any_tx_output_on_change_branch, \
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Testnet" if constants.net.TESTNET else "Kotia"
