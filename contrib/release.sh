...
# - update locale:
#     1. cd /opt/electrum-kot-locale && ./update.py && git push
...
# create tarball
tarball="Electrum-KOT-$VERSION.tar.gz"
...
srctarball="Electrum-KOT-sourceonly-$VERSION.tar.gz"
...
# appimage
appimage="electrum-kot-$REV-x86_64.AppImage"
...
# windows
win1="electrum-kot-$REV.exe"
win2="electrum-kot-$REV-portable.exe"
win3="electrum-kot-$REV-setup.exe"
...
# android
apk1="Electrum-KOT-$VERSION.0-armeabi-v7a-release.apk"
apk1_unsigned="Electrum-KOT-$VERSION.0-armeabi-v7a-release-unsigned.apk"
apk2="Electrum-KOT-$VERSION.0-arm64-v8a-release.apk"
apk2_unsigned="Electrum-KOT-$VERSION.0-arm64-v8a-release-unsigned.apk"
apk3="Electrum-KOT-$VERSION.0-x86_64-release.apk"
apk3_unsigned="Electrum-KOT-$VERSION.0-x86_64-release-unsigned.apk"
