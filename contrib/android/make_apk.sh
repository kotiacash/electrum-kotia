...
# defaults:
#   export APP_PACKAGE_NAME=Electrum-KOT
#   export APP_PACKAGE_DOMAIN=org.electrum_kot
...
#export APP_PACKAGE_DOMAIN=org.electrum_kot.testnet
...
if [[ "$3" == "release" ]] ; then
    ...
    export P4A_RELEASE_KEYALIAS=electrum_kot
    ...
    export P4A_DEBUG_KEYALIAS=electrum_kot
