...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="/tmp/electrum_build/windows/fresh_clone/electrum-kot"
...
docker run -it \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/wine64/drive_c/electrum-kot \
    --rm \
    --workdir /opt/wine64/drive_c/electrum-kot/contrib/build-wine \
