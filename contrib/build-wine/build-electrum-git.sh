...
pushd $WINEPREFIX/drive_c/electrum-kot
...
LOCALE="$WINEPREFIX/drive_c/electrum-kot/electrum_kot/locale/"
...
cd dist
mv electrum-kot-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
