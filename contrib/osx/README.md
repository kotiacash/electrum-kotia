...
This guide explains how to build Electrum-KOT binaries for macOS systems.
...
- The unix username should be `vagrant`, and `electrum-kot` should be cloned directly
  to the user's home dir: `/Users/vagrant/electrum-kot`.
...
- Make sure that you are building from a fresh clone of electrum-kot
...
#### 2. Build Electrum-KOT

    cd electrum-kot
    ./contrib/osx/make_osx.sh

This creates both a folder named Electrum-KOT.app and the .dmg file.
