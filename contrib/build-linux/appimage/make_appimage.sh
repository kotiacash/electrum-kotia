...
APPDIR="$BUILDDIR/electrum-kot.AppDir"
...
APPIMAGE="$DISTDIR/electrum-kot-$VERSION-x86_64.AppImage"
...
info "preparing electrum-kot-locale."
(
    cd "$PROJECT_ROOT"
...
cp "$PROJECT_ROOT/electrum-kot.desktop" "$APPDIR/electrum-kot.desktop"
cp "$PROJECT_ROOT/electrum_kot/gui/icons/electrum.png" "$APPDIR/electrum.png"
