...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="/tmp/electrum_build/appimage/fresh_clone/electrum-kot"
...
docker run -it \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/electrum-kot \
    --rm \
    --workdir /opt/electrum-kot/contrib/build-linux/appimage \
